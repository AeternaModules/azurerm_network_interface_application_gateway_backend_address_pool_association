output "network_interface_application_gateway_backend_address_pool_associations_id" {
  ...
  value       = { for k, v in azurerm_network_interface_application_gateway_backend_address_pool_association.network_interface_application_gateway_backend_address_pool_associations : k => v.id if v.id != null && length(v.id) > 0 }
}
output "network_interface_application_gateway_backend_address_pool_associations_backend_address_pool_id" {
  ...
  value       = { for k, v in azurerm_network_interface_application_gateway_backend_address_pool_association.network_interface_application_gateway_backend_address_pool_associations : k => v.backend_address_pool_id if v.backend_address_pool_id != null && length(v.backend_address_pool_id) > 0 }
}
output "network_interface_application_gateway_backend_address_pool_associations_ip_configuration_name" {
  ...
  value       = { for k, v in azurerm_network_interface_application_gateway_backend_address_pool_association.network_interface_application_gateway_backend_address_pool_associations : k => v.ip_configuration_name if v.ip_configuration_name != null && length(v.ip_configuration_name) > 0 }
}
output "network_interface_application_gateway_backend_address_pool_associations_network_interface_id" {
  ...
  value       = { for k, v in azurerm_network_interface_application_gateway_backend_address_pool_association.network_interface_application_gateway_backend_address_pool_associations : k => v.network_interface_id if v.network_interface_id != null && length(v.network_interface_id) > 0 }
}
