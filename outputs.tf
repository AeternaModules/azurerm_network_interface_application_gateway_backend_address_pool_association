...
output "network_interface_application_gateway_backend_address_pool_associations_backend_address_pool_id" {
  ...
  value       = [for k, v in azurerm_network_interface_application_gateway_backend_address_pool_association.network_interface_application_gateway_backend_address_pool_associations : v.backend_address_pool_id]
}
output "network_interface_application_gateway_backend_address_pool_associations_ip_configuration_name" {
  ...
  value       = [for k, v in azurerm_network_interface_application_gateway_backend_address_pool_association.network_interface_application_gateway_backend_address_pool_associations : v.ip_configuration_name]
}
output "network_interface_application_gateway_backend_address_pool_associations_network_interface_id" {
  ...
  value       = [for k, v in azurerm_network_interface_application_gateway_backend_address_pool_association.network_interface_application_gateway_backend_address_pool_associations : v.network_interface_id]
}
